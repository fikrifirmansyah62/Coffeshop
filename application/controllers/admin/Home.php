...
class Home extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $data['TotalDonasi']  = $this->db->select_sum('order_detail_donasi', 'total')->get_where('resto_order_detail'   )->row();
        $data['TotalBersih']  = $this->db->select_sum('order_detail_bersih', 'total')->get_where('resto_order_detail' )->row();
