    ...
    <div class="col-full">
        ...
        <div class="header-wrap">
            <div class="site-branding">
                <a href="<?=base_url('home');?>" class="custom-logo-link" rel="home">
            ...
            <div class="header-info-wrapper">
				...
				<div class="col-sm-2" >
				<br><br><button id="button" type="button" class="btn btn-danger" 
				style="font-size:18px" > <a href="logout" style="color:white" onclick="return confirm('Anda yakin keluar dari aplikasi ?')">
