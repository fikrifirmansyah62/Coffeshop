    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="col-md-3 control-label">Status Konfirm</label>
                    <div class="col-md-9">
                        <select class="form-control" name="lstKonfirm" id="lstKonfirm">
                            <option value="">- SEMUA -</option>
                            <option value="1">Belum Konfirm</option>
    ...
    table = $('#tableData').DataTable({
        ...
        "ajax": {
            ...
            "data": function(data) {
                ...
                data.lstKonfirm = $('#lstKonfirm').val();
...
function konfirmData(order_id) {
    ...
    swal({
        ...
        if (!isConfirm) return;
        $.ajax({
            url : "<?=site_url('admin/order/confirmdata')?>/"+id,
            type: "POST",
...
function hapusData(order_id) {
    ...
    swal({
        ...
        if (!isConfirm) return;
        $.ajax({
            url : "<?=site_url('admin/order/deletedata')?>/"+id,
            type: "POST",
            success: function(data) {
                swal({
                    title:"Sukses",
