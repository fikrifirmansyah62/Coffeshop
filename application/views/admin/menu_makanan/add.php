            ...
            <div class="col-md-12">
                ...
                <div class="portlet box blue-madison">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-plus-circle"></i> Form Tambah Menu
                        </div>
                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <input type="text" class="form-control" placeholder="Enter Nama Makanan" name="nama" id="nama" autocomplete="off" autofocus>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-5">
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <input type="text" class="form-control number" placeholder="0" name="harga" autocomplete="off" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    $("#formInput").validate({
        ...
        rules: { 
            nama: {
                required: true,
                remote: {
                    url: "<?=site_url('admin/menu_makanan/register_nama_exists');?>",
                    type: "post",
                    data: {
                        nama: function() { 
                            return $("#nama").val(); 
        ...
        messages: {
            nama: { required:'Nama Menu harus diisi', remote: 'Nama Menu sudah Ada' },
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                ...
                data: formData,
                async: true,
                url: "<?=site_url('admin/menu_makanan/savedata');?>",
                type: "POST",
