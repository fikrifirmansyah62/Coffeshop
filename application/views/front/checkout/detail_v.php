                ...
                <div id="post-9" class="post-9 page type-page status-publish hentry">
                    ...
                    <div class="entry-content">
                        <div class="woocommerce">
                            <center><p class="woocommerce-thankyou-order-received">Terima Kasih, Pesanan Anda Kami Terima.</p>
                            ...
                            <ul class="woocommerce-thankyou-order-details order_details">
                                ...
                                <li class="date">Qty:<strong><?=$Order->order_qty.' ';?></strong></li>
                            ...
                            <div class="clear"></div>
                            <p>Silahkan melakukan pembayaran setelah anda menerima pesanan.</p>
                            <h2>Order Detail</h2>
